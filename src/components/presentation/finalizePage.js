...
import { useFirestore } from 'react-redux-firebase';
   function Finalize(props) {
     ...
     let additionalSection=props.additionalSection;
     let projectsSection = props.projectsSection;
    ...
    const saveToDatabase= async()=>{
      ...
      if(user.resumeIds!=undefined)
       newObj = {...user.resumeIds,[documentd.id]:{additionalSection:additionalSection,projectsSection:projectsSection , skillsSection:skillsSection, educationSection:educationSection,contactSection:contactSection,document:documentd}}
       else
       newObj={[document.id]:{additionalSection:additionalSection, projectsSection:projectsSection ,skillsSection:skillsSection, educationSection:educationSection,contactSection:contactSection,document:document}}
    ...
    return (
      ...
      <div className="funnel-section ">
          <div className="finalize-preview-card " id="resumePreview">
            <ResumePreview contactSection={contactSection} educationSection={educationSection} skillsSection={skillsSection} projectsSection={projectsSection} additionalSection={additionalSection} skinCd={props.document.skinCd}></ResumePreview>   
          </div>
